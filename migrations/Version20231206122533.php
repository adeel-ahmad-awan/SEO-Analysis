 ...
 */
final class Version20231206122533 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__meta_tag AS SELECT id, name, content FROM meta_tag');
        $this->addSql('DROP TABLE meta_tag');
        $this->addSql('CREATE TABLE meta_tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, page_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, content VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_AC05690EC4663E4 FOREIGN KEY (page_id) REFERENCES page (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO meta_tag (id, name, content) SELECT id, name, content FROM __temp__meta_tag');
        $this->addSql('DROP TABLE __temp__meta_tag');
